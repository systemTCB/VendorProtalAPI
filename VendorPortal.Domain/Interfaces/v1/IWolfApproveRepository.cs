...
namespace VendorPortal.Domain.Interfaces.v1
{
    public interface IWolfApproveRepository
    {
        ...
        Task<SP_GET_PURCHASE_ORDER_DETAIL> SP_GET_PURCHASE_ORDER_DETAIL(string id , string supplier_id);
        ...
        // Claim
        Task<List<SP_GET_CLAIM_LIST>> SP_GET_CLAIM_LIST(string supplier_id,string company_id,string from_date,string to_date);
