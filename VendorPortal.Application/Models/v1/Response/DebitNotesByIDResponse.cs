...
{
    public class DebitNotesByIDResponse : BaseResponse
    {
        public DebitNotesByData data { get; set; }
    }
    public class DebitNotesByData
    {
        ...
        public DateTime debit_note_date { get; set; }
        public string debit_note_cause { get; set; }
        ...
        public InvoiceDebitNotes invoice { get; set; }
        public List<LineDebitNotes> lines { get; set; }
        public List<DocumentDebitNotes> documents { get; set; }

    }

    public class InvoiceDebitNotes
    {
        public string id { get; set; }
        public string invoice_number { get; set; }
        public string status { get; set; }
    ...
    public class DocumentDebitNotes
    {
