...
namespace VendorPortal.Application.Interfaces.v1
{
    public interface IWolfApproveService
    {
        ...
        // Purchase Order
        Task<PurchaseOrderResponse> GetPurchaseOrderList(string q, string supplier_id, string number, string start_date, string end_date, string purchase_type_id, string status_id, string category_id, string page, string per_page, string order_direction, string order_by);
